    ...
    <nav className="z-10 bg-white border-b border-gray-700 dark:bg-gray-800 fixed top-0 left-0 w-full">
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
        <a className="flex items-center bg" href="/">
          <img src="etherspawn.svg" className="h-8 mr-3" alt="Etherspawn Logo" />
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Etherspawn</span>
          ...
          <a href="https://github.com/guilyx/Etherspawn" target="_blank" rel="noopener noreferrer" className="flex items-center ml-3 mr-3">
            {/* Twitter icon with margin */}
